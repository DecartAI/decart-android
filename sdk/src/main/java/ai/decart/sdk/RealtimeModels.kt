...
object RealtimeModels {
    // Canonical models
    val LUCY_2_1 = RealtimeModel("lucy-2.1", "/v1/stream", 30, 1088, 626)
    val LUCY_2_1_VTON = RealtimeModel("lucy-2.1-vton", "/v1/stream", 30, 1088, 626)
    val LUCY_VTON_2 = RealtimeModel("lucy-vton-2", "/v1/stream", 30, 1088, 626)
    val LUCY_RESTYLE_2 = RealtimeModel("lucy-restyle-2", "/v1/stream", 30, 1280, 704)

    // Latest aliases (server-side resolution)
    val LUCY_LATEST = RealtimeModel("lucy-latest", "/v1/stream", 30, 1088, 626)
    val LUCY_VTON_LATEST = RealtimeModel("lucy-vton-latest", "/v1/stream", 30, 1088, 626)
    ...
    val LUCY_VTON = RealtimeModel("lucy-vton", "/v1/stream", 30, 1088, 626)

    @Deprecated("Use LUCY_VTON_2 instead", replaceWith = ReplaceWith("LUCY_VTON_2"))
    val LUCY_2_1_VTON_2 = RealtimeModel("lucy-2.1-vton-2", "/v1/stream", 30, 1088, 626)
